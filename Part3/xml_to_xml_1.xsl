...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
            ...
            <owners>
                <xsl:for-each select="veterinary_clinic/owners/owner">
                    <owner>
                        ...
                        <email_o>
                            <xsl:call-template name="email_o"/>
                        </email_o>
                    </owner>
                </xsl:for-each>
            </owners>
    ...
    <xsl:template name="presence_of_castration">
        <xsl:attribute name="presence_of_castration">
            <xsl:value-of select="@presence_of_castration"/>
        </xsl:attribute>
    </xsl:template>

    <xsl:template name="no_microchip">
        <xsl:attribute name="no_microchip">
    ...
    <xsl:template name="email_o">
        <xsl:value-of select="email_o"/>
    </xsl:template>
